...
public class EnumTest implements Parcelable {
  ...
  **/
  ...
  EnumTest(Parcel in) {
    enumString = (EnumString)in.readValue(null);
    enumStringRequired = (EnumStringRequired)in.readValue(null);
    enumInteger = (EnumInteger)in.readValue(null);
    enumNumber = (EnumNumber)in.readValue(null);
