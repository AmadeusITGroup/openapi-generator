...
[Master](https://github.com/OpenAPITools/openapi-generator/tree/master) (`7.4.0-amadeus`):
...
JAR location: `https://repository.rnd.amadeus.net/maven-dev-odi-nce/org/openapitools/openapi-generator-cli/7.4.0-amadeus/openapi-generator-cli-7.4.0-amadeus.jar`

For **Mac/Linux** users:
```sh
wget https://repository.rnd.amadeus.net/maven-dev-odi-nce/org/openapitools/openapi-generator-cli/7.4.0-amadeus/openapi-generator-cli-7.4.0-amadeus.jar -O openapi-generator-cli.jar
```

For **Windows** users, you will need to install [wget](http://gnuwin32.sourceforge.net/packages/wget.htm) or you can use Invoke-WebRequest in PowerShell (3.0+), e.g.
```
Invoke-WebRequest -OutFile openapi-generator-cli.jar https://repository.rnd.amadeus.net/maven-dev-odi-nce/org/openapitools/openapi-generator-cli/7.4.0-amadeus/openapi-generator-cli-7.4.0-amadeus.jar
```
...
<!-- RELEASE_VERSION -->
You can also download the JAR (latest release) directly from [amadeus-maven-central](https://repository.rnd.amadeus.net/maven-dev-odi-nce/org/openapitools/openapi-generator-cli/7.4.0-amadeus/openapi-generator-cli-7.4.0-amadeus.jar)
<!-- /RELEASE_VERSION -->
