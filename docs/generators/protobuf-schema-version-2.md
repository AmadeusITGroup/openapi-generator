---
title: Documentation for the protobuf-schema-version-2 Generator
---
...
| -------- | ----- | ----- |
| generator name | protobuf-schema-version-2 | pass this to the generate command after -g |
...
| ------ | ----------- | ------ | ------- |
|checkPropertiesDuplication|Check duplication on properties.| |false|
|enumStructNameAsPrefix|Uses enum structure name as prefix for the enum values.| |false|
|fieldNamesInSnakeCase|Field names in snake_case.| |false|
|keepEnumNameOriginalCase|Keep the original case of enum name.| |false|
